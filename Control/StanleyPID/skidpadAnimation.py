...
fig = plt.figure()
trajectoryPlot = fig.add_subplot(autoscale_on=False, xlim=(-20, 20), ylim=(-16, 13))
trajectoryPlot.set_aspect('equal')

referenceTraj, = trajectoryPlot.plot([], [], 'g-', label="Reference Track", zorder=1, lw=1)
...
def animate(i):
    ...
    return referenceTraj, carTraj, timeText
